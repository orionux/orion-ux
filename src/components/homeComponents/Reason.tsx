...
const Reason = () => {
    return (
        <>
            <div className="d-flex flex-column-reverse flex-lg-row py-5 padding-x-100px">
                <div className="col-12 col-lg-6 px-3">
                    <h2 className='font-space-g font-500 font-48px mb-4'>Why should you choose the US?</h2>
                    <ul className='list-styles'>
                        <li className='mb-3'>we have highly skilled UI/UX engineers with excellent technical knowledge and experience.</li>
                    ...
                    <Link href={'#'} className=''>
                        <Image src={'/assests/images/contact-us button.png'} alt='' width={200} height={50} className='img-fluid' />
                    </Link>
                </div>
                <div className="col-12 col-lg-6 px-3 d-flex justify-content-center align-item-center">
                    <Image src={'/assests/images/why-side-img.png'} alt='' width={500} height={400} className='img-fluid' />
                </div>
            </div>
        </>
    )
