          ...
          <div className="d-flex flex-column justify-content-end flex-lg-row row row-cols-1 row-cols-md-2 row-cols-lg-5 col-position">
            ...
            <div onClick={handleClickPink} className="col col-pink col-laptop d-flex flex-column justify-content-center align-items-center">
              ...
              <div className="d-flex flex-row">
                ...
                <div className="col-8">
                  <p className="text-start font-400 font-inter font-5px mb-1" style={{color:'##4A4A4A'}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet lacus, vitae amet, elit. Elit, elit, tortor ipsum quis pellentesque nisl. Lobortis nulla elementum pellentesque risus, laoreet sit. Praesent sit et, risus,</p>
